...
public class ICResponse<T> implements Serializable {
    ...
    ICResponse(T data, Integer code, String msg, PageDTO page) {
        this.code = code;
        this.data = data;
        this.msg = msg;
        this.page = page;
    ...
    ICResponse(Integer code, String msg) {
        this(null, code, msg, null);
    }

    public static <T> ICResponse<T> success(T data) {
        ICResponse response = new ICResponse(ResponseCodeEnum.SUCCESS.getCode(), ResponseCodeEnum.SUCCESS.getMsg());
