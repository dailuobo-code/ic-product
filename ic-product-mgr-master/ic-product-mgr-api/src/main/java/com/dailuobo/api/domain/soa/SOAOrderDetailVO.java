 ...
 */
public class SOAOrderDetailVO implements Serializable {
	...
	private List<SOAOrderDetail> orderDetailLst;
	 ...
	 */
	public List<SOAOrderDetail> getOrderDetailLst() {
		return orderDetailLst;
	}
	 ...
	 */
	public void setOrderDetailLst(List<SOAOrderDetail> orderDetailLst) {
