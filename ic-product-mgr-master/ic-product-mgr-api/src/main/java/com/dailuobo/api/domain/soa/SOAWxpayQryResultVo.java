...
/**
 * The Class SOAWxpayQryResultVo.
 */
public class SOAWxpayQryResultVo implements Serializable {
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1700488028276464633L;
	 ...
	 * 设置 queryTradeStatus.
	 *
	 * @param queryTradeStatus the new query trade status
	 */
