 ...
 */
public class SOAStoreProduct implements Serializable, Comparable<SOAStoreProduct> {
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 3961156214770466081L;
	...
	//zyc 添加于2018-03-13 ：新增属性，用于预售判断是否有库存，该状态不区分上下架情况
	private Integer stockNum;
	
	private Integer newUserPro;
	...
	@Override
	public int compareTo(SOAStoreProduct o) {
