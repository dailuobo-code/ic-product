...
public class SOAHPTheme implements Serializable {

	private static final long serialVersionUID = 1117735597780691973L;
	...
	List<SOAStoreProduct> productList;
	 ...
	 * @return productList
	 */
	public List<SOAStoreProduct> getProductList() {
		return productList;
	}
	/**
	 * 设置 productList
	 * @param productList
	 */
	public void setProductList(List<SOAStoreProduct> productList) {
