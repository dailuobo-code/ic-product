 ...
 * 结算订单详情对象
 */
public class SOAOrderDetailjs implements Serializable {
	...
	private Integer refundType;// 找零退回方式 1

	private Integer pointPrice;

	private Integer actualPointPrice;//实际结算积分
	...
	public void setSortingStr(String sortingStr) {
	...
	public Integer getActualPointPrice() {
		return actualPointPrice;
	}

	public void setActualPointPrice(Integer actualPointPrice) {
		this.actualPointPrice = actualPointPrice;
	}
}
