...
/**
 * The Class SOAOrderDetailVO.
 */
public class SOAUndOrderDetailVO implements Serializable {
	
	private static final long serialVersionUID = 7302733811796233257L;
	...
	private List<SOAUnderOrderDetailjs> orderDetailLst;
	 ...
	 */
	public List<SOAUnderOrderDetailjs> getOrderDetailLst() {
		return orderDetailLst;
	}
	 ...
	 * 设置 orderDetailLst.
	 *
	 * @param orderDetailLst the new order detail lst
	 */
	public void setOrderDetailLst(List<SOAUnderOrderDetailjs> orderDetailLst) {
	 ...
	 * 设置 childStatus.
	 *
	 * @param childStatus the new child status
	 */
