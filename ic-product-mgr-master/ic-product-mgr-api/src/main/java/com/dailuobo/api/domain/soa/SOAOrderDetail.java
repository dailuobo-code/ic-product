...
/**
 * The Class SOAOrderDetail.
 */
public class SOAOrderDetail implements Serializable, Comparable<SOAOrderDetail> {

    /**
     * The Constant serialVersionUID.
     */
    private static final long serialVersionUID = -8319843223311567267L;
    ...
    @Override
    public int compareTo(SOAOrderDetail o) {
