...
public class JsonMapper {
     ...
     * 同时允许指定命名规则
     */
    public static JsonMapper nonEmptyMapper(PropertyNamingStrategy caseStrategy) {
        JsonMapper jsonMapper = new JsonMapper(Include.NON_EMPTY);
        jsonMapper.mapper.setPropertyNamingStrategy(caseStrategy);
        return jsonMapper;
    }
    ...
    public <T> T fromJson(byte[] source, Class<T> clazz) {
        ...
        try {
            ...
            logger.warn("parse json string error: " + new String(source), e);
            return null;
        }
    }
