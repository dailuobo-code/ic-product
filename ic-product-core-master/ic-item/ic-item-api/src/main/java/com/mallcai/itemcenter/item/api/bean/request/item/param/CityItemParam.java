...
import com.mallcai.itemcenter.item.api.bean.response.item.GroupedOtherAttributeInfo;
import com.mallcai.itemcenter.item.api.bean.response.item.GroupedSkuAttributeInfo;
...
@Data
@ApiModel("商品")
public class CityItemParam extends ApiExtraParam implements Serializable {
    private static final long serialVersionUID = 2848825931568094529L;
